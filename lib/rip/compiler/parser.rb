...
module Rip::Compiler
  class Parser < Parslet::Parser
    ...
    rule(:block_body_switch) { whitespaces? >> brace_open.as(:location_body) >> whitespaces? >> ((case_block >> whitespaces?).repeat(1) >> else_block.maybe).as(:body) >> whitespaces? >> brace_close }
